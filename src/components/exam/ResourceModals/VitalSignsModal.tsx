...
import { X, Thermometer, Heart, Wind, Activity } from 'lucide-react';
...
const VitalSignsModal = ({ isOpen, onClose }: Props) => {
        ...
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Vital Signs</h2>
            </div>
            <button
              onClick={onClose}
